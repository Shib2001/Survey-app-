...
export const Sidebar: React.FC<Props> = ({ active, onChange }) => {
  ...
  const SidebarContent = (
    <div className="w-60 h-full bg-white dark:bg-secondary-900 border-r border-gray-100 dark:border-secondary-800 flex flex-col transition-colors">
      ...
      {/* Footer */}
      <div className="px-5 py-4 border-t border-gray-100 dark:border-secondary-800">
