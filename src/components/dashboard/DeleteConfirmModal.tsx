    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-secondary-900 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200 p-6 relative">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white">Delete Survey?</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Are you sure you want to delete this survey? This action cannot be undone.</p>
          </div>
        </div>
